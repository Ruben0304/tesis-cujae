...
![Comparación de modelos de predicción solar.](comparacion_modelos_solar.png){#fig:comparacion-solar width=85%}
...
![Importancia de variables del modelo Random Forest solar.](feature_importance_solar.png){#fig:importance-solar width=80%}
...
![Perfil de producción diaria simulado: día soleado vs nublado.](perfil_produccion_diaria.png){#fig:perfil-diario width=80%}
